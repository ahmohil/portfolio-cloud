...
export const experience: Experience[] = [
  {
    ...
    bullets: [
      ...
      "Built the core localization formatters using the browser's native Intl API, enabling accurate currency, number, and date formatting across 26+ locales (BCP47 tags).",
